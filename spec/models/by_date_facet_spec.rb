...
# Unit tests for Nodeum::ByDateFacet
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ByDateFacet' do
  before do
    # run before each test
    @instance = Nodeum::ByDateFacet.new
  end
  ...
  describe 'test an instance of ByDateFacet' do
    it 'should create an instance of ByDateFacet' do
      expect(@instance).to be_instance_of(Nodeum::ByDateFacet)
    end
  end
