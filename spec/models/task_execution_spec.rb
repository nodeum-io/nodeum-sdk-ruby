...
# Unit tests for Nodeum::TaskExecution
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TaskExecution' do
  before do
    # run before each test
    @instance = Nodeum::TaskExecution.new
  end
  ...
  describe 'test an instance of TaskExecution' do
    it 'should create an instance of TaskExecution' do
      expect(@instance).to be_instance_of(Nodeum::TaskExecution)
    end
  end
  ...
  describe 'test attribute "to_process_files"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "processed_files"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "finalized_files"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "estimation_time"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
