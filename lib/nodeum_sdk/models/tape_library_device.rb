...
module Nodeum
  class TapeLibraryDevice
    ...
    attr_accessor :storage_slots

    attr_accessor :storage_slots_address

    attr_accessor :io_slots

    attr_accessor :io_slots_address
    ...
    def protocol=(protocol)
      validator = EnumAttributeValidator.new('String', ["scsi", "acsls"])
