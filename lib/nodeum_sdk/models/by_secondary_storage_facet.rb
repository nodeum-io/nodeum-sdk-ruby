...
module Nodeum
  class BySecondaryStorageFacet
    ...
    attr_accessor :on_secondary_nas

    attr_accessor :on_secondary_public_cloud

    attr_accessor :on_secondary_object_cloud
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Nodeum::BySecondaryStorageFacet` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Nodeum::BySecondaryStorageFacet`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'on_secondary_nas')
        self.on_secondary_nas = attributes[:'on_secondary_nas']
      end

      if attributes.key?(:'on_secondary_public_cloud')
        self.on_secondary_public_cloud = attributes[:'on_secondary_public_cloud']
      end

      if attributes.key?(:'on_secondary_object_cloud')
        self.on_secondary_object_cloud = attributes[:'on_secondary_object_cloud']
      end

      if attributes.key?(:'on_secondary_tape')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cost == o.cost &&
          on_secondary_nas == o.on_secondary_nas &&
    ...
    def hash
      [count, files_count, file_size_sum, cost, on_secondary_nas, on_secondary_public_cloud, on_secondary_object_cloud, on_secondary_tape, on_any_secondary, on_no_secondary].hash
    end
